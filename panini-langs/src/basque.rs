...
mod tests {
    ...
    #[test]
    fn demonstrative_pronouns_preserve_number() {
        let singular = BasqueMorphology::Pronoun {
            lemma: "hau".to_string(),
        ...
        assert_eq!(
            BasqueMorphology::PIVOT_DETERMINATION.value(&singular),
            Some("definite_singular".to_string())
        );
        assert_eq!(
