...
mod tests {
    ...
    #[test]
    fn ordinary_du_uses_an_unmarked_not_familiar_register() {
        assert_eq!(
            SwedishAddressRegister::all_variants(),
            &["unmarked", "formal"]
        );
    }
