    ...
    fn schema_fragment(&self, _lang: &L) -> serde_json::Value {
        serde_json::json!({
            ...
            "description": concat!(
                ...
                "1. **Analysis**: A bullet list analyzing key grammatical components of the sentence.\n",
                ...
                "2. **Grammar Recap**: A summary box of the specific declensions, conjugations, or rules used.\n",
                "   Use: <div class=\"grammar-recap\">",
                "<b>Grammar Recap:</b><br>...</div>\n\n",
                "IMPORTANT: Do NOT include translations (literal or natural) as they are already displayed separately. ",
                "No introductory or concluding chatter. No \"Here is...\" or \"Great example!\". ",
